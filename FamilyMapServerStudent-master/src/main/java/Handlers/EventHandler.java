 ...
 * Request Body: None
 * Errors: Invalid auth token, Invalid eventID parameter,
        ...
        try{
            if(exchange.getRequestMethod().toUpperCase().equals("GET")){
                ...
                if (reqHeaders.containsKey("Authorization")) {
                    ...
                    String eventID = paths[paths.length - 1];
                    if (eventID != null) {
                        // pass the event object to the specific service to make a result obj
                        EventService eventService = new EventService();
                        eventResult = eventService.singleEvent(eventID, authToken);
            ...
            String resultString = JSONSerializer.serialize(eventResult);
