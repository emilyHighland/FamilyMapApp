...
/**
 * Each generated Person's associated properties.
 */
public class Person {
     ...
     * @param associatedUsername user's (username) to which this person belongs
     * @param firstName person's first name
     * @param lastName person's last name
     * @param gender person's gender ('m' or 'f')
     * @param fatherID personID of person's father (possibly null)
     * @param motherID personID of person's mother (possible null)
     * @param spouseID personID of person's spouse (possibly null)
     */
